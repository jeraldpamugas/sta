    ...
    <nav class="navbar navbar-default">
        <div style="background-color: #54b9cd;" class="container-fluid">
          <div class="navbar-header">
            ...
            <a style="color: white" class="navbar-brand {{ (request()->segment(2) == 'transactionsByStatus') ? 'active' : '' }}" href="{{ url('/home') }}">STA-Home</a>
          </div>
          <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="nav navbar-nav">
                @if($usertype != 'staff')
                <li role="presentation"><a id="navItem" class="navi {{ (request()->segment(2) == 'items') ? 'active' : '' }}" style="color: white" href="{{ url('/items') }}">Item</a></li>
                <li role="presentation"><a id="navWH" class="navi {{  (request()->segment(2) == 'warehouses') ? 'active' : '' }}" style="color: white" href="{{ url('/warehouses') }}">Warehouse</a></li>
                @endif
            </ul>
